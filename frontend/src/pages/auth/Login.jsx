      ...
      <div className="row h-100">
        <div className="col-lg-6 d-flex align-items-center justify-content-center">
          <div className="card p-5 shadow" style={{ width: "420px" }}>
            ...
            <p className="text-muted mb-4">Login to your Amara Lands account</p>
        ...
        <div className="col-lg-6 bg-primary text-white d-none d-lg-flex align-items-center justify-content-center">
          <div>
            <h1 className="display-4 fw-bold">Amara Lands</h1>

            <p className="lead">Smart Property Management Platform</p>
          </div>
        </div>
      </div>
    </div>
